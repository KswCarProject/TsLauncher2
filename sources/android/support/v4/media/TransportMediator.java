...
public class TransportMediator extends TransportController {
    ...
    static boolean isMediaKey(int keyCode) {
        switch (keyCode) {
            case KeyDef.PKEY_RADIO_5S /*79*/:
            case KeyDef.PKEY_DISP /*85*/:
            case KeyDef.PKEY_FAV /*86*/:
            case KeyDef.PKEY_DIMUP /*87*/:
            case KeyDef.PKEY_DIMDN /*88*/:
            case KeyDef.PKEY_ECAR /*89*/:
            case KeyDef.PKEY_PLAY /*90*/:
            case KeyDef.PKEY_PAUSE /*91*/:
