...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    public AppWidgetResizeFrame(Context context, LauncherAppWidgetHostView widgetView, CellLayout cellLayout, DragLayer dragLayer) {
        ...
        if (context.getResources().getInteger(R.integer.myiconback) == 0) {
            ...
            this.mWidgetPaddingRight = 0;
            this.mWidgetPaddingBottom = 0;
        }
    ...
    public void snapToWidget(boolean animate) {
        ...
        ObjectAnimator oa = LauncherAnimUtils.ofPropertyValuesHolder(lp, PropertyValuesHolder.ofInt("width", new int[]{lp.width, newWidth}), PropertyValuesHolder.ofInt("height", new int[]{lp.height, newHeight}), PropertyValuesHolder.ofInt("x", new int[]{lp.x, newX}), PropertyValuesHolder.ofInt("y", new int[]{lp.y, newY}));
