...
public class Hotseat extends FrameLayout {
    ...
    public Hotseat(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mIsLandscape = context.getResources().getConfiguration().orientation != 2 ? false : z;
    }
    ...
    public void resetLayout() {
        ...
        if (context.getResources().getInteger(R.integer.allapptext) != 0) {
            allAppsButton.setText(context.getString(R.string.all_apps_button_label));
        }
        allAppsButton.setContentDescription(context.getString(R.string.all_apps_button_label));
        allAppsButton.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                if (Hotseat.this.mLauncher == null || (event.getAction() & MotionEventCompat.ACTION_MASK) != 0) {
                    return false;
                }
        ...
        MyWorkspace.GetInstance().setupAllapp(allAppsButton, this.mAllAppsButtonRank);
    }
}
