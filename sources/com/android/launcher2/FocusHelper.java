...
public class FocusHelper {
    ...
    static boolean handleAppsCustomizeKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        ViewGroup newParent;
        ViewGroup newParent2;
        ViewGroup newParent3;
        ViewGroup newParent4;
        if (v.getParent() instanceof PagedViewCellLayoutChildren) {
            ...
            int cellCountY = ((PagedViewCellLayout) parentLayout).getCellCountY();
        } else {
            parentLayout = (ViewGroup) v.getParent();
            itemContainer = parentLayout;
            countX = ((PagedViewGridLayout) parentLayout).getCellCountX();
            int cellCountY2 = ((PagedViewGridLayout) parentLayout).getCellCountY();
        }
        PagedView container = (PagedView) parentLayout.getParent();
        TabWidget tabWidget = findTabHostParent(container).getTabWidget();
        ...
        int pageCount = container.getChildCount();
        int i = iconIndex % countX;
        int i2 = iconIndex / countX;
        boolean handleKeyEvent = e.getAction() != 1;
        switch (keyCode) {
            case 19:
                if (handleKeyEvent) {
            ...
            case 21:
                if (handleKeyEvent) {
                    if (iconIndex > 0) {
                        itemContainer.getChildAt(iconIndex - 1).requestFocus();
                    } else if (pageIndex > 0 && (newParent4 = getAppsCustomizePage(container, pageIndex - 1)) != null) {
                        container.snapToPage(pageIndex - 1);
                        View child3 = newParent4.getChildAt(newParent4.getChildCount() - 1);
                        if (child3 != null) {
                            child3.requestFocus();
                        }
                    }
            ...
            case 22:
                if (handleKeyEvent) {
                    if (iconIndex < itemCount - 1) {
                        itemContainer.getChildAt(iconIndex + 1).requestFocus();
                    } else if (pageIndex < pageCount - 1 && (newParent3 = getAppsCustomizePage(container, pageIndex + 1)) != null) {
                        container.snapToPage(pageIndex + 1);
                        View child4 = newParent3.getChildAt(0);
                        if (child4 != null) {
                            child4.requestFocus();
                        }
                    }
            ...
            case KeyDef.PKEY_VIEW360 /*92*/:
                if (handleKeyEvent) {
                    if (pageIndex > 0) {
                        ViewGroup newParent5 = getAppsCustomizePage(container, pageIndex - 1);
                        if (newParent5 != null) {
                            container.snapToPage(pageIndex - 1);
                            View child5 = newParent5.getChildAt(0);
                            if (child5 != null) {
                                child5.requestFocus();
                            }
                        }
            ...
            case KeyDef.PKEY_MODE_UP /*93*/:
                if (handleKeyEvent) {
                    if (pageIndex < pageCount - 1) {
                        ViewGroup newParent6 = getAppsCustomizePage(container, pageIndex + 1);
                        if (newParent6 != null) {
                            container.snapToPage(pageIndex + 1);
                            View child6 = newParent6.getChildAt(0);
                            if (child6 != null) {
                                child6.requestFocus();
                            }
                        }
