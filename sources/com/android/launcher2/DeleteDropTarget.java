...
public class DeleteDropTarget extends ButtonDropTarget {
    private static int DELETE_ANIMATION_DURATION = KeyDef.RKEY_J;
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (isUninstall) {
            setCompoundDrawablesWithIntrinsicBounds((Drawable) null, this.mUninstallDrawable, (Drawable) null, (Drawable) null);
        } else {
            setCompoundDrawablesWithIntrinsicBounds((Drawable) null, this.mRemoveDrawable, (Drawable) null, (Drawable) null);
        }
        this.mCurrentDrawable = (TransitionDrawable) getCurrentDrawable();
        ...
        if (getText().length() > 0) {
            if (isUninstall) {
                ...
                i = R.string.delete_target_label;
            }
            setText(i);
        }
    }
