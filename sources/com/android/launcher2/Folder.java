...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener, View.OnLongClickListener, DropTarget, FolderInfo.FolderListener, TextView.OnEditorActionListener, View.OnFocusChangeListener {
    ...
    public void animateOpen() {
        ...
        if (getParent() instanceof DragLayer) {
            centerAboutIcon();
            final ObjectAnimator oa = LauncherAnimUtils.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat("alpha", new float[]{1.0f}), PropertyValuesHolder.ofFloat("scaleX", new float[]{1.0f}), PropertyValuesHolder.ofFloat("scaleY", new float[]{1.0f}));
            this.mOpenCloseAnimator = oa;
            ...
            post(new Runnable() {
                public void run() {
                    if (oa == Folder.this.mOpenCloseAnimator) {
                        oa.start();
                    }
                }
            });
    ...
    public void animateClosed() {
        if (getParent() instanceof DragLayer) {
            final ObjectAnimator oa = LauncherAnimUtils.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat("alpha", new float[]{0.0f}), PropertyValuesHolder.ofFloat("scaleX", new float[]{0.9f}), PropertyValuesHolder.ofFloat("scaleY", new float[]{0.9f}));
            this.mOpenCloseAnimator = oa;
            oa.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
