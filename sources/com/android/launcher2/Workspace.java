...
public class Workspace extends SmoothPagedView implements DropTarget, DragSource, DragScroller, View.OnTouchListener, DragController.DragListener, LauncherTransitionable, ViewGroup.OnHierarchyChangeListener {
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        a.recycle();
        this.mCanLoop = res.getInteger(R.integer.canloop) != 0;
        this.mNoScrollPage = res.getInteger(R.integer.noScrollPage);
        this.mBackCenter = res.getInteger(R.integer.backcenter);
        DefaultWorkspace.SetWorkspace(this);
    ...
    public void notifyPageSwitchListener() {
        ...
        Launcher.setScreen(this.mCurrentPage);
        Log.d("hdd", new StringBuilder(String.valueOf(this.mCurrentPage)).toString());
        if (this.listener != null) {
            this.listener.OnListener(this.mCurrentPage);
        }
    }
    ...
    private float wallpaperOffsetForCurrentScroll() {
        if (this.mBackCenter > 0) {
            return ((float) this.mBackCenter) / 10.0f;
        }
    ...
    private void animateBackgroundGradient(float finalAlpha, boolean animated) {
        if (this.mBackground != null) {
            ...
            if (animated) {
                this.mBackgroundFadeOutAnimation = LauncherAnimUtils.ofFloat(startAlpha, finalAlpha);
    ...
    public void setListener(CurrentPageListener listener2) {
    ...
    public void screenScrolled(int screenCenter) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            CellLayout cl = (CellLayout) getChildAt(i);
            MyWorkspace.GetInstance().Scroll(cl, getScrollProgress(screenCenter, cl, i));
        }
    }
            ...
            for (int index = 0; index < getChildCount(); index++) {
                ...
                if (this.mOldAlphas[i2] == 0.0f && this.mNewAlphas[i2] == 0.0f) {
                    ...
                    if (this.mOldBackgroundAlphas[i2] != 0.0f || this.mNewBackgroundAlphas[i2] != 0.0f) {
                        ValueAnimator bgAnim = LauncherAnimUtils.ofFloat(0.0f, 1.0f).setDuration((long) duration);
    ...
    private Bitmap createDragOutline(View v, Canvas canvas, int padding) {
        int outlineColor = getResources().getColor(17170450);
        ...
        if (d.dragSource != this) {
                                ...
                                finalResizeRunnable = new Runnable() {
                                    public void run() {
                                        if (!Workspace.this.isPageMoving()) {
                                            ...
                                            Workspace.this.mDelayedResizeRunnable = r2;
                                        }
                                    }
                                };
                            }
            ...
            if (d.dragView.hasDrawn()) {
                ...
                if (info2.itemType == 4) {
                    ...
                    animateWidgetDrop(info2, parent, d.dragView, r0, animationType, cell, false);
                } else {
    ...
    class FolderCreationAlarmListener implements OnAlarmListener {
        ...
        public void onAlarm(Alarm alarm) {
            if (Workspace.this.mDragFolderRingAnimator == null) {
                Workspace.this.mDragFolderRingAnimator = new FolderIcon.FolderRingAnimator(Workspace.this.mLauncher, (FolderIcon) null);
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x00cb, code lost:
        if (willAddToExistingUserFolder((com.android.launcher2.ItemInfo) r60.dragInfo, r58, r55.mTargetCell, r11) != false) goto L_0x00cd;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onDropExternal(int[] r56, java.lang.Object r57, com.android.launcher2.CellLayout r58, boolean r59, com.android.launcher2.DropTarget.DragObject r60) {
        /*
            r55 = this;
            com.android.launcher2.Workspace$8 r50 = new com.android.launcher2.Workspace$8
            r0 = r50
            r1 = r55
            r0.<init>()
            r30 = r57
            com.android.launcher2.ItemInfo r30 = (com.android.launcher2.ItemInfo) r30
            r0 = r30
            int r5 = r0.spanX
            r0 = r30
            int r6 = r0.spanY
            r0 = r55
            com.android.launcher2.CellLayout$CellInfo r2 = r0.mDragInfo
        ...
        L_0x0027:
            r0 = r55
            com.android.launcher2.Launcher r2 = r0.mLauncher
            r0 = r58
        ...
        L_0x0035:
            ...
            r0 = r55
            com.android.launcher2.Workspace$State r2 = r0.mState
            com.android.launcher2.Workspace$State r3 = com.android.launcher2.Workspace.State.SPRING_LOADED
        ...
        L_0x0063:
            r0 = r30
            boolean r2 = r0 instanceof com.android.launcher2.PendingAddItemInfo
            if (r2 == 0) goto L_0x01b3
            r24 = r57
            com.android.launcher2.PendingAddItemInfo r24 = (com.android.launcher2.PendingAddItemInfo) r24
            r51 = 1
            r0 = r24
            int r2 = r0.itemType
            r3 = 1
            ...
            com.android.launcher2.ItemInfo r8 = (com.android.launcher2.ItemInfo) r8
            r0 = r55
            ...
            com.android.launcher2.ItemInfo r2 = (com.android.launcher2.ItemInfo) r2
            r0 = r55
        ...
        L_0x00cf:
            ...
            r25 = r0
            com.android.launcher2.ItemInfo r25 = (com.android.launcher2.ItemInfo) r25
            r54 = 0
        ...
        L_0x0144:
            ...
            r0.spanY = r2
        L_0x0152:
            com.android.launcher2.Workspace$9 r22 = new com.android.launcher2.Workspace$9
            r23 = r55
            ...
            r2 = r24
            com.android.launcher2.PendingAddWidgetInfo r2 = (com.android.launcher2.PendingAddWidgetInfo) r2
        ...
        L_0x0168:
            ...
            int r4 = r0.spanY
            r0 = r49
            com.android.launcher2.AppWidgetResizeFrame.updateWidgetSizeRanges(r0, r2, r3, r4)
        L_0x0185:
            r34 = 0
            r0 = r24
            int r2 = r0.itemType
            ...
            com.android.launcher2.PendingAddWidgetInfo r24 = (com.android.launcher2.PendingAddWidgetInfo) r24
            r0 = r24
        ...
        L_0x019a:
            r0 = r60
            com.android.launcher2.DragView r0 = r0.dragView
            r32 = r0
            r36 = 1
            r29 = r55
            r31 = r58
        ...
        L_0x01d5:
            ...
            r0 = r30
            boolean r2 = r0 instanceof com.android.launcher2.ApplicationInfo
            if (r2 == 0) goto L_0x01f2
            com.android.launcher2.ShortcutInfo r52 = new com.android.launcher2.ShortcutInfo
            com.android.launcher2.ApplicationInfo r30 = (com.android.launcher2.ApplicationInfo) r30
            r0 = r52
            r1 = r30
            r0.<init>((com.android.launcher2.ApplicationInfo) r1)
            r30 = r52
        L_0x01f2:
            r0 = r55
            com.android.launcher2.Launcher r3 = r0.mLauncher
            int r4 = com.android.launcher.R.layout.application
            r2 = r30
            com.android.launcher2.ShortcutInfo r2 = (com.android.launcher2.ShortcutInfo) r2
            r0 = r58
            android.view.View r37 = r3.createShortcut(r4, r0, r2)
        L_0x0202:
            if (r56 == 0) goto L_0x0270
            r2 = 0
            r3 = r56[r2]
            r2 = 1
            r4 = r56[r2]
        ...
        L_0x02a4:
            ...
            com.android.launcher2.CellLayout$LayoutParams r53 = (com.android.launcher2.CellLayout.LayoutParams) r53
            com.android.launcher2.ShortcutAndWidgetContainer r2 = r58.getShortcutsAndWidgets()
            r0 = r37
            r2.measureChild(r0)
            r0 = r55
            com.android.launcher2.Launcher r0 = r0.mLauncher
            r38 = r0
            r0 = r53
            int r0 = r0.cellX
            r43 = r0
            ...
            r40 = r26
            r42 = r28
            com.android.launcher2.LauncherModel.addOrMoveItemInDatabase(r38, r39, r40, r42, r43, r44)
            r0 = r60
            com.android.launcher2.DragView r2 = r0.dragView
            if (r2 == 0) goto L_0x01ab
            r0 = r55
            r1 = r58
            ...
            r0 = r55
            com.android.launcher2.Launcher r2 = r0.mLauncher
            com.android.launcher2.DragLayer r2 = r2.getDragLayer()
            r0 = r60
            com.android.launcher2.DragView r3 = r0.dragView
            r0 = r37
            r1 = r50
            ...
            goto L_0x01ab
        L_0x0323:
            int r3 = com.android.launcher.R.layout.folder_icon
            r0 = r55
            com.android.launcher2.Launcher r4 = r0.mLauncher
            r2 = r30
            com.android.launcher2.FolderInfo r2 = (com.android.launcher2.FolderInfo) r2
            r0 = r55
            com.android.launcher2.IconCache r7 = r0.mIconCache
            r0 = r58
            com.android.launcher2.FolderIcon r37 = com.android.launcher2.FolderIcon.fromXml(r3, r4, r0, r2, r7)
            goto L_0x0202
        L_0x0339:
            r0 = r55
            int[] r2 = r0.mTargetCell
    ...
    /* access modifiers changed from: package-private */
    public void removeItems(ArrayList<String> packages) {
        ...
        while (it.hasNext()) {
            ...
            post(new Runnable() {
                /* JADX WARNING: Code restructure failed: missing block: B:30:0x00dd, code lost:
                    r8 = (com.android.launcher2.LauncherAppWidgetInfo) r15;
                 */
                /* Code decompiled incorrectly, please refer to instructions dump. */
                public void run() {
                    /*
                    ...
                    L_0x0031:
                        ...
                        boolean r0 = r15 instanceof com.android.launcher2.ShortcutInfo
                        r17 = r0
                        if (r17 == 0) goto L_0x0079
                        r8 = r15
                        com.android.launcher2.ShortcutInfo r8 = (com.android.launcher2.ShortcutInfo) r8
                        ...
                        r17 = r0
                        java.lang.String r18 = r13.getPackageName()
                        boolean r17 = r17.contains(r18)
                        if (r17 == 0) goto L_0x0076
                        r0 = r19
                        com.android.launcher2.Workspace r0 = com.android.launcher2.Workspace.this
                        r17 = r0
                        com.android.launcher2.Launcher r17 = r17.mLauncher
                        r0 = r17
                        com.android.launcher2.LauncherModel.deleteItemFromDatabase(r0, r8)
                        r0 = r16
                        r5.add(r0)
                    L_0x0076:
                        int r11 = r11 + 1
                        goto L_0x0013
                    L_0x0079:
                        boolean r0 = r15 instanceof com.android.launcher2.FolderInfo
                        r17 = r0
                        if (r17 == 0) goto L_0x00d7
                        r8 = r15
                        com.android.launcher2.FolderInfo r8 = (com.android.launcher2.FolderInfo) r8
                        java.util.ArrayList<com.android.launcher2.ShortcutInfo> r6 = r8.contents
                        int r7 = r6.size()
                    ...
                    L_0x0094:
                        ...
                        com.android.launcher2.ShortcutInfo r10 = (com.android.launcher2.ShortcutInfo) r10
                        r8.remove(r10)
                        r0 = r19
                        com.android.launcher2.Workspace r0 = com.android.launcher2.Workspace.this
                        r18 = r0
                        com.android.launcher2.Launcher r18 = r18.mLauncher
                        r0 = r18
                        com.android.launcher2.LauncherModel.deleteItemFromDatabase(r0, r10)
                        goto L_0x0094
                    L_0x00b3:
                        java.lang.Object r1 = r6.get(r12)
                        com.android.launcher2.ShortcutInfo r1 = (com.android.launcher2.ShortcutInfo) r1
                    ...
                    L_0x00d4:
                        ...
                        goto L_0x008e
                    L_0x00d7:
                        boolean r0 = r15 instanceof com.android.launcher2.LauncherAppWidgetInfo
                        r17 = r0
                        if (r17 == 0) goto L_0x0076
                        r8 = r15
                        com.android.launcher2.LauncherAppWidgetInfo r8 = (com.android.launcher2.LauncherAppWidgetInfo) r8
                        android.content.ComponentName r14 = r8.providerName
                        if (r14 == 0) goto L_0x0076
                        r0 = r19
                        java.util.HashSet r0 = r4
                        r17 = r0
                        java.lang.String r18 = r14.getPackageName()
                        boolean r17 = r17.contains(r18)
                        if (r17 == 0) goto L_0x0076
                        r0 = r19
                        com.android.launcher2.Workspace r0 = com.android.launcher2.Workspace.this
                    ...
                    L_0x010a:
                        ...
                        r0 = r19
                        com.android.launcher2.CellLayout r0 = r3
                        r17 = r0
                        r0 = r17
                        r0.removeViewInLayout(r3)
                        boolean r0 = r3 instanceof com.android.launcher2.DropTarget
                        r17 = r0
                        if (r17 == 0) goto L_0x0132
                        r0 = r19
                        com.android.launcher2.Workspace r0 = com.android.launcher2.Workspace.this
                        r17 = r0
                        com.android.launcher2.DragController r17 = r17.mDragController
                        com.android.launcher2.DropTarget r3 = (com.android.launcher2.DropTarget) r3
                        r0 = r17
                    ...
                    L_0x0132:
                        ...
                        goto L_0x001a
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.android.launcher2.Workspace.AnonymousClass11.run():void");
                }
            });
        }
                    ...
                    synchronized (newApps) {
                        ...
                        while (iter.hasNext()) {
                            try {
                                ...
                                if (packageNames.contains(ItemInfo.getPackageName(intent))) {
                                    iter.remove();
                                }
